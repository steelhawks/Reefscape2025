...
public enum ChoreoPaths {
    ...
    LOWER_SOURCE_TO_BR1("Lower Source to BR1", StartEndPosition.LOWER_SOURCE, StartEndPosition.BR1, ReefZones.BR),

    R1_TO_LOWER_SOURCE("R1 to Lower Source",StartEndPosition.R1, StartEndPosition.LOWER_SOURCE, ReefZones.UNDEFINED),
    R1_TO_UPPER_SOURCE("R1 to Lower Source",StartEndPosition.R1, StartEndPosition.UPPER_SOURCE, ReefZones.UNDEFINED),
    R2_TO_LOWER_SOURCE("R2 to Lower Source", StartEndPosition.R2, StartEndPosition.LOWER_SOURCE, ReefZones.UNDEFINED),

    RC1_TO_BR1("RC1 to BR1", StartEndPosition.RC1, StartEndPosition.BR1, ReefZones.BR),
    RC1_TO_BR2("RC1 to BR2", StartEndPosition.RC1, StartEndPosition.BR2, ReefZones.BR),

    RC1_TO_R1("RC1 to R1", StartEndPosition.RC1, StartEndPosition.R1, ReefZones.R),
    RC1_TO_R2("RC1 to R2", StartEndPosition.RC1, StartEndPosition.R2, ReefZones.R),

    RC2_TO_BR1("RC2 to BR2", StartEndPosition.RC2, StartEndPosition.BR2, ReefZones.BR),
    RC2_TO_BR2("RC2 to BR2", StartEndPosition.RC2, StartEndPosition.BR2, ReefZones.BR),

    RC2_TO_R2("RC2 to R2", StartEndPosition.RC2, StartEndPosition.R2, ReefZones.R),
    RC2_TO_R1("RC2 to R2", StartEndPosition.RC2, StartEndPosition.R1, ReefZones.R),
    ...
    RC3_TO_BR1("RC3 to BR1", StartEndPosition.RC3, StartEndPosition.BR1, ReefZones.BR),
    RC3_TO_BR2("RC3 to BR1", StartEndPosition.RC3, StartEndPosition.BR2, ReefZones.BR),
    ...
    UPPER_SOURCE_TO_L2("Upper Source to L2", StartEndPosition.UPPER_SOURCE, StartEndPosition.L2, ReefZones.L),
    UPPER_SOURCE_TO_R1("Upper Source to R1", StartEndPosition.UPPER_SOURCE, StartEndPosition.R1, ReefZones.L),
