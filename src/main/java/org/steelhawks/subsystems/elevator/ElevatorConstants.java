...
public class ElevatorConstants {
    ...
    public static final Double MAX_VELOCITY_ROT_PER_SEC = Constants.omega(15.0, 10.0);
    public static final Double MAX_ACCELERATION_ROT_PER_SEC_2 = Constants.omega(17.0, 20.0);
